    ...
    while (1)
    {
        ...
        if (event.type == SDL_MOUSEBUTTONDOWN)
        {
            if (event.button.button == SDL_BUTTON_LEFT)
            {
                ...
                case 2:
                    if (((x > enig->choix_B_position.x && x < enig->choix_B_position.x + 20) && (y > enig->choix_B_position.y && y < enig->choix_B_position.y + 50)) || (event.key.keysym.sym == SDLK_a))
                    {
                        n = 1;
                        Mix_PlayChannel(1, sonWin, 0);
                    }
                ...
                case 3:
                    if (((x > enig->choix_C_position.x && x < enig->choix_C_position.x + 20) && (y > enig->choix_C_position.y && y < enig->choix_C_position.y + 50)) || (event.key.keysym.sym == SDLK_a))
                    {
                        n = 1;
                        Mix_PlayChannel(1, sonWin, 0);
                    }

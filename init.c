...
poslogo.x = 1220;
  ...
  posredb.x = 1125;
  posredb.y = 125;
  posNORMAL.x=800;posNORMAL.y=235;
 posFULLSCREEN.x=920;posFULLSCREEN.y=235;
  posHIGH.x=820;posHIGH.y=293;
posMEDIUM.x=910;posMEDIUM.y=293;
posLOW.x=1000;posLOW.y=293;
...
if (Mix_OpenAudio(44100, MIX_DEFAULT_FORMAT, MIX_DEFAULT_CHANNELS, 1024) == -1)
  ...
  musique = Mix_LoadMUS("Action-Movie-Music-Epic-Suspenseful-Fight-Scene-FesliyanStudios.mp3");
